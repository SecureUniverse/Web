...
- Output redirection
  ...
  - <div dir="rtl" > عکس ها در مسیر فوق ذخیره شده اند، در این حالت خروجی دستور، در مسیر share شده ذخیره می گردد و بعدا می توانیم یکی از عکس های محصولات را باز کرده، سپس نام  فایل را با نام output.txt تغییر دهیم، تا نتیجه دستور را مشاهده کنیم</div>
