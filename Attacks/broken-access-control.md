...
- درون Response بخش هایی از سایت (مانند تغییر ایمیل) اگر roleid مشاهده شود، می توانیم ، آن را درون Request قرار دهیم، تا roleid خود را از کاربر معمولی به ادمین تغییر دهیم.
