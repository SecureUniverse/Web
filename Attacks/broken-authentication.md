...
- اگر به ازای درخواست زیاد روی IP بلاک شویم، باید هدر ```X-Forwarded-For``` را به درخواست اضافه کنیم
  - برای ترکیب این حالت با حملات قبل، از نوع حمله Pitchfork استفاده می کنیم 
  - نوع payload برای هدر را Number قرار داده، از 1 تا 100 با پله های 1، همچنین Max fraction digits را روی 0 قرار می دهیم
