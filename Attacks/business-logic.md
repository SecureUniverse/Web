...
- با استفاده از تنظیمات زیر در Burp می توانیم تعداد زیادی درخواست خرید ارسال کنیم تا قیمت به انتهای ظرفیت متغییر برسد و منفی شود، با ادامه ارسال درخواست در بخش Repeater می توانیم به قیمت نزدیک به صفر برسیم
  - Intruder > Payloads > Null paylode > (Continue indefinitely / Generate 300 Payload)
